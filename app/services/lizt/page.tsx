    ...
    <ServicePageTemplate
      ...
      customHero={
        <div className="relative w-full" style={{ backgroundColor: "#0F172A" }}>
          ...
          >
            <path
              d="M 1400 400 Q 1200 300, 1000 250"
              fill="none"
              stroke="rgba(255, 255, 255, 0.06)"
              strokeWidth="1.5"
            />
            <path
              d="M 1400 400 Q 1200 400, 1000 400"
              fill="none"
              stroke="rgba(255, 255, 255, 0.08)"
              strokeWidth="1.5"
            />
            <path
              d="M 1400 400 Q 1200 500, 1000 550"
              fill="none"
              stroke="rgba(255, 255, 255, 0.06)"
              strokeWidth="1.5"
            />
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 1000px 900px at 50% 40%, rgba(255, 255, 255, 0.03) 0%, rgba(15, 23, 42, 0) 70%)",
            }}
          />
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-[40px]">
                ...
                <div className="flex flex-col gap-[28px] max-w-[800px] md:max-w-[650px]">
                  <div className="flex flex-col gap-[12px]">
                    <p className="font-normal text-white/70 text-[12px] uppercase tracking-[1.2px]">
