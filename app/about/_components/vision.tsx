    ...
    <section className="relative w-full bg-white py-[80px] md:py-[100px]">
      <div className="max-w-[1200px] w-full mx-auto px-5 md:px-10">
        <div className="max-w-[900px] mx-auto">
          <h2 className="font-semibold text-navy text-[24px] md:text-[40px] leading-[1.2] mb-8 text-center">
            Who We Are
          </h2>

          <div className="space-y-6">
            <p className="font-normal text-navy/70 text-[15px] md:text-[18px] leading-[1.8]">
