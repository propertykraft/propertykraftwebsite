    ...
    <main className="bg-white min-h-screen">
      ...
      {customHero ? (
        ...
        <div className="bg-navy relative w-full">
          ...
          <div className="relative z-[2] flex flex-col items-center pt-[120px] md:pt-[180px] pb-[80px] md:pb-[120px] px-4 md:px-8 w-full">
            ...
            {/* Hero Image */}
            {heroImage && (
              <div className="max-w-[1000px] w-full mt-[60px] md:mt-[80px]">
      ...
      {/* Gradient Transition — always present */}
      <div
